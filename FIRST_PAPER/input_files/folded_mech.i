...
[BCs]
  active = 'bottom_disp_y temperature_bottom pore_pressure_top temperature_top right_disp_x left_disp_x'
  [./temperature_top]
    type = DirichletBC
    variable = temp
    boundary = 2
