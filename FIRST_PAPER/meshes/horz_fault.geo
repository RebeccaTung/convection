...
ymin = -1;
y1 = -0.3; // top of LHS
y2 = -0.4; // bottom of LHS
y3 = -0.5; // top of RHS
y4 = -0.6; // bottom of RHS
ymax = 0;
...
Physical Line(4) = {3}; // top of middle layer
Physical Line(5) = {6}; // bottom of middle layer

Physical Surface(0) = {11}; // bottom block
Physical Surface(1) = {12}; // middle block
Physical Surface(2) = {13}; // top block

Physical Point(21) = {1,2}; // bottom corners
Physical Point(22) = {7,8}; // top corners
Physical Point(23) = {4,3}; // top corners of fault
Physical Point(24) = {6,5}; // bottom corners of fault
