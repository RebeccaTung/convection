...
[Mesh]
  ...
  file = conv_case2.msh
  dim = 2
  block_name = 'graben musc basement'
  block_id = '78 79 80'
  boundary_name = 'top right bottom left fault_left fault_right musc_bottom'
  boundary_id = '72 73 74 75 76 77 81'
[]
